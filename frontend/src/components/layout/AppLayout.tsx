    ...
    <div className="relative flex h-screen w-full overflow-hidden bg-[var(--background)] text-[var(--foreground)] selection:bg-cyan-500/20 transition-colors duration-300">
      ...
      <div className="fixed bottom-6 left-24 z-30">
         <motion.div 
            ...
            className="flex items-center gap-4 rounded-3xl border border-white/10 bg-[#080d18]/80 p-1.5 pr-6 backdrop-blur-xl shadow-2xl shadow-purple-500/20"
         >
            ...
            <div>
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white leading-none">Active Policy</p>
               <p className="mt-1 text-[9px] font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap">Auto-mitigating active...</p>
            </div>
         </motion.div>
      </div>
    </div>
