...
export function Sidebar(_props: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'relative z-20 hidden h-full flex-shrink-0 flex-col border-r border-white/5 bg-[#0a0f1a] text-slate-100 transition-[width] duration-300 ease-out md:flex w-64'
      )}
    >
