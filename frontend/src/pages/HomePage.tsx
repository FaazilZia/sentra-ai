...
const HomePage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white transition-colors duration-500">
      {/* Specially Requested Atom Background */}
      <AtomBackground />
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Atom background: invert for dark mode */
        ...
        /* Smooth transition */
        html.dark * { transition: background-color 0.4s ease, color 0.3s ease, border-color 0.4s ease; }
      `}} />
    </div>
  );
};
