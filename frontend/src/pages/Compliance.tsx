  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-24 pb-32 px-8 pt-16">
      ...
      <div className="space-y-4">
        <h1 className="text-sm font-black tracking-widest text-slate-400 uppercase">Regulatory Governance OS</h1>
          ...
          <div key={framework.name} className="space-y-6">
            <div className="p-8 rounded-3xl bg-slate-900/40 border border-white/5 space-y-6">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{framework.name} Framework</span>
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-2">Readiness Score</p>
              </div>
            </div>
            ...
            <div className="px-4 flex items-center justify-between">
               ...
               <button className="text-[9px] font-black text-white uppercase tracking-widest hover:text-slate-300 transition-all">
                 View Details →
               </button>
            </div>
          </div>
      ...
      <div className="p-12 rounded-[2.5rem] bg-slate-900/20 border border-dashed border-white/10 flex flex-col items-center text-center space-y-8">
         <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400 max-w-md mx-auto">Export a cryptographically signed compliance ledger for regulatory submission.</p>
         </div>
