        ...
        <div className="hidden lg:flex items-center gap-10">
          {['Platform', 'Solutions', 'Compliance', 'Security'].map((item) => (
            <button 
              ...
              className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--muted)] hover:text-[var(--foreground)] transition-colors relative group"
            >
              {item}
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 0 20px rgba(14,165,233,0.4), 0 4px 15px rgba(2,132,199,0.3)',
            }}
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden border-t border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-3xl overflow-hidden"
          >
            <div className="flex flex-col p-6 gap-6">
              {['Platform', 'Solutions', 'Compliance', 'Security'].map((item) => (
                <button
                  ...
                  className="text-left text-[10px] font-black uppercase tracking-[0.2em] text-[var(--muted)] hover:text-[var(--foreground)] transition-colors"
                >
                  {item}
                </button>
              ))}
              <div className="h-px bg-[var(--glass-border)] my-2" />
              <button onClick={handleLogin} className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-blue-500">
                <Lock className="h-4 w-4" /> Login
              </button>
              <button 
                onClick={handleRequestDemo} 
                className="flex items-center justify-center gap-3 p-4 rounded-xl text-[10px] font-black uppercase tracking-widest text-white shadow-lg"
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="relative lg:pl-10">
            ...
            <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-indigo-500/10 blur-[120px] rounded-full animate-pulse-slow" />
                   <div className="relative p-10 md:p-14 premium-glass !rounded-[4rem] bg-gradient-to-b from-slate-200/50 to-slate-300/50 dark:from-slate-800/40 dark:to-slate-900/40 border border-white/20 dark:border-white/5 flex flex-col gap-10 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)]">
               <div className="noise-overlay" />
               ...
               <motion.div 
                 ...
                 whileInView={{ opacity: 1, scale: 1 }}
                 viewport={{ once: true }}
                 className="flex items-center gap-8 p-10 bg-blue-500/[0.08] dark:bg-blue-500/[0.12] rounded-[2.5rem] border border-blue-500/30 backdrop-blur-md relative z-10 shadow-xl"
               >
                  <div className="h-16 w-16 rounded-3xl bg-blue-500 flex items-center justify-center text-white shadow-[0_0_30px_rgba(59,130,246,0.5)]">
                    <Check className="h-10 w-10 stroke-[3]" />
                  </div>
                  <div>
                    <p className="text-[12px] font-black uppercase text-blue-500 tracking-[0.25em] mb-1.5">SAFE INPUT</p>
                    <p className="text-[var(--foreground)] font-black text-2xl md:text-3xl leading-tight tracking-tight">"Draft a welcome email template"</p>
                  </div>
               </motion.div>
               ...
               <motion.div 
                 ...
                 className="flex items-center gap-8 p-10 bg-red-500/[0.08] dark:bg-red-500/[0.12] rounded-[2.5rem] border border-red-500/40 backdrop-blur-md relative z-10 shadow-xl"
               >
                  <div className="h-16 w-16 rounded-3xl bg-fuchsia-600 dark:bg-red-500 flex items-center justify-center text-white shadow-[0_0_30px_rgba(239,68,68,0.5)]">
                    <Ban className="h-10 w-10 stroke-[3]" />
                  </div>
                  <div>
                    <p className="text-[12px] font-black uppercase text-red-500 tracking-[0.25em] mb-1.5">DANGER BLOCKED</p>
                    <p className="text-[var(--foreground)] font-black text-2xl md:text-3xl leading-tight tracking-tight">"Export all customer credit cards"</p>
                  </div>
               </motion.div>

               <div className="text-center mt-4">
                  <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-slate-900/10 dark:bg-white/5 border border-slate-900/20 dark:border-white/10 backdrop-blur-xl shadow-inner">
                    ...
                    <p className="text-[11px] font-black uppercase text-[var(--foreground)] tracking-[0.3em] opacity-80">Sentra Engine: ACTIVE-RESPONSE MODE</p>
                  </div>
               </div>
            </div>
          </div>
...
const FeaturesSection = () => {
  ...
  return (
    <section id="solutions" className="py-40 scroll-mt-32">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeading 
