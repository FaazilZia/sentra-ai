...
class Settings(BaseSettings):
    ...
    cors_origins: str = Field(
        default="http://localhost:5173,http://127.0.0.1:5173,https://sentra-ai-nudb.vercel.app,https://sentra-ai-tau.vercel.app,https://sentra-h9khz3zmh-faazilzias-projects.vercel.app,https://sentra-ai-1.onrender.com,https://sentra-ai-frontend.onrender.com",
        alias="CORS_ORIGINS",
    )
